...
path_model_yolo = r'C:\Lap trinh\realsense\project\models\best_ad.pt'
path_model_mobilenet_center = r'C:\Lap trinh\realsense\final_project\model\model_onnx.onnx'
...
def load_models(path_model_yolo, path_model_mobilenet_center):
    ...
    model_center = mobilev3ad.load_model_onnx(path_model_mobilenet_center)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        start = time.time()
        result = solution(rgb, depth_raw, model_yolo, model_center, tracker)
        end = time.time()
